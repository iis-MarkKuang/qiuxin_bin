...
install:
	...
	ln -sf "../$(PROG)/current/bin/api-server-main" "$(PREFIX)/bin/api-server-main"
	ln -sf "../$(PROG)/current/bin/marc4j-test" "$(PREFIX)/bin/marc4j-test"
	ln -sf "../$(PROG)/current/bin/marc-test" "$(PREFIX)/bin/marc-test"
	ln -sf "../$(PROG)/current/bin/proxy" "$(PREFIX)/bin/proxy"
